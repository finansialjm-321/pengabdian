...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cm49OoJ9.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-stYq-Lqq.mjs").then((n2) => n2.k),
    import("./start-wyCf_yTd.mjs"),
...
export {
  ...
  requireReactDom as W,
  resolveManifestAssetLink as X,
  resolvePath as Y,
  rewriteBasepath as Z,
  rootRouteId as _,
  React$1 as a,
  trimPath as a0,
  trimPathLeft as a1,
