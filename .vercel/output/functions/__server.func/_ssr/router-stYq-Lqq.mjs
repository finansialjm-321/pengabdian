...
const appCss = "/assets/styles-BhF-zNj4.css";
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 w-full border-b border-border/60 bg-[#493725] backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 overflow-hidden items-center justify-center rounded-lg bg-white p-1 shadow-md transition-transform duration-300 group-hover:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: "/logo.png",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold tracking-tight text-white transition-opacity group-hover:opacity-90", children: "Jakarta Mengabdi" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-white/70", children: "Berita & Kegiatan" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            to: "/",
            className: `relative px-3 py-2 text-sm font-medium transition-colors rounded-md hover:text-white ${isActive("/") ? "text-white" : "text-white/70"}`,
            children: [
              "News",
              isActive("/") && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-0.5 left-1/2 h-0.5 w-6 -translate-x-1/2 rounded-full bg-white transition-all" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: "Jakarta Mengabdi"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-5 w-px bg-white/20 rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: toggleTheme,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `absolute transition-all duration-500 ease-in-out transform ${isDark ? "translate-y-0 rotate-0 opacity-100" : "translate-y-8 rotate-90 opacity-0"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `absolute transition-all duration-500 ease-in-out transform ${isDark ? "-translate-y-8 -rotate-90 opacity-0" : "translate-y-0 rotate-0 opacity-100"}`,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-24 border-t border-white/10 bg-[#493725]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 py-12 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-8 sm:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 sm:items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded bg-white p-0.5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: "/logo.png",
            alt: "Logo Jakarta Mengabdi",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold tracking-tight text-white", children: "Jakarta Mengabdi" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-sm text-white/70", children: [
        "Membangun komunitas, membagi cerita",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-4 w-4 fill-red-500 text-red-500 animate-pulse" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-5 sm:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/admin/login",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs tracking-wider text-white/40", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " JAKARTA MENGABDI. ALL RIGHTS RESERVED."
      ] })
    ] })
  ] }) }) });
}
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold", children: "Halaman gagal dimuat" }),
...
const Route$6 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Jakarta Mengabdi — Berita & Kegiatan Komunitas" },
      { name: "description", content: "Portal berita kegiatan dan pengabdian komunitas Jakarta Mengabdi." },
      { property: "og:title", content: "Jakarta Mengabdi" },
      { property: "og:description", content: "Portal berita kegiatan dan pengabdian komunitas." },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { richColors: true, position: "top-right" })
  ] });
}
const $$splitComponentImporter$5 = () => import("./news-BVcESwp0.mjs");
const Route$5 = createFileRoute("/news")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-CpIRtkmC.mjs");
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.news-B9IvLlCE.mjs");
const Route$3 = createFileRoute("/admin/news")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.login-B8kr1fkJ.mjs");
const Route$2 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.journeys-C8bggAdd.mjs");
const Route$1 = createFileRoute("/admin/journeys")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.dashboard-BGqF_Yz-.mjs");
const Route2 = createFileRoute("/admin/dashboard")({
...
const AdminNewsRoute = Route$3.update({
  id: "/admin/news",
  path: "/admin/news",
  getParentRoute: () => Route$6
});
...
const AdminJourneysRoute = Route$1.update({
  id: "/admin/journeys",
  path: "/admin/journeys",
  getParentRoute: () => Route$6
});
const AdminDashboardRoute = Route2.update({
  id: "/admin/dashboard",
